...
class PhysicsInformedNN:
    ...
    def train_adam(self, n_iters):
        ...
        for epoch in range(n_iters):
            ...
            if self.adam_iter % 500 == 0:
                ...
                print("Iter %d, Loss: %.4e, loss_ini: %.4e" % \
                      (self.adam_iter, loss.item(), loss_ini.item()))
    ...
    def closure(self):
        ...
        if self.LBFGS_iter % 500 == 0:
            print("Iter %d, Loss: %.4e, loss_ini: %.4e" % \
                  (self.LBFGS_iter, loss_LBFGS.item(), loss_ini_LBFGS.item()))
...
if __name__ == '__main__':
    ...
    fig_dir = 'log/fig_mirror_ini'
    save_dir = 'log/save_mirror_ini'
