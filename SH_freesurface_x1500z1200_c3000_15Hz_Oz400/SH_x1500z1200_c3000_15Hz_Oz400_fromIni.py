...
if __name__ == '__main__':
    fig_dir = 'log/fig_z1200_fromIni'
    save_checkpoints_dir = 'log/save_z1200_fromIni'
    ...
    #  # train
    checkpoints_path = "log/save_mirror_ini/LBFGS_checkpoints_5000.dump"
    print("====== Start train Now ... =======")
    # train it, if networks are not provided
    model = PhysicsInformedNN(X_input, layers, ExistModel=1, model_Dir=checkpoints_path)
