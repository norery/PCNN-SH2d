...
#     plt.show()
    ...
    with open(f'{save_dir}/SH_adam_loss_tanh.pickle', 'wb') as f:
    ...
    with open(f'{save_dir}/K_list_log_tanh.pickle', 'wb') as f:
    ...
    with open(f'{save_dir}/SH_LBFGS_loss_tanh.pickle', 'wb') as f:
